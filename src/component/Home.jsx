    ...
    {/* about section */}
      ...
      <div className="mb-5 w-full">
        ...
        <div className=" md:flex gap-5 w-full">
          ...
          <div data-aos="fade-up" className=" w-full p-3 shadow-md rounded-lg shadow-slate-400 mb-5 md:mb-0 flex flex-col items-center md:items-start">
      ...
      <div className="mb-5 w-full">
        ...
        <div className=" md:flex gap-5 w-full">
          ...
          <div data-aos="fade-up" className=" w-full p-3 shadow-md rounded-lg shadow-slate-400 md:mb-0 md:flex items-center gap-10 md:items-start">
...
function Card({ img, title, about }) {
  return (
    <div data-aos="fade-up" className=" px-3 py-5 shadow-md rounded-lg shadow-slate-400 mb-5 md:mb-0 flex flex-col items-center md:items-start">
