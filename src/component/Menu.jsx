  ...
  return (
    <div>
        <ul className=' xl:mt-20 w-full mx-auto md:flex items-center justify-center gap-10 p-3'>
            <Link to={"/"}>
                <li className=' bg-white rounded-xl text-center font-semibold capitalize mb-5 md:mb-0 flex flex-col h-44 md:h-auto items-center justify-center gap-4 md:gap-2  px-5 py-3 border-[1px] border-slate-300 shadow-md shadow-slate-300'><img className='w-16' src={home1} alt="home" />home</li>
            </Link>
